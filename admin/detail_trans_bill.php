                    ...
                    <div class="row px-5 mt-3">
                        <div class="col-6">
                            <?php
                                ...
                                echo "Bắt đầu: ".date('d/m/Y', strtotime($start)) . "</br>"; 
                                echo "Hoàn thành: ".date('d/m/Y', strtotime($finish));
                                // echo "Hoàn thành: " .date('d/m/Y', strtotime($finish));

                                // $sql = "select * from hoa_don where DVC_MA = {$id}";
                                $sql = "select * 
                                            from gio_hang gh 
                                            join hoa_don hd on gh.GH_MA=hd.GH_MA 
                                            join khach_hang kh on gh.KH_MA=kh.KH_MA 
                                            where hd.DVC_MA={$id}";
                                ...
                                foreach ($result_all as $row) {
                                  ...
                                  <tr class="height-50">
                                    ...
                                    <td class="align-middle text-center">
                                      <!-- ten dt -->
                                      <?php 
                                        $s_kh = "select KH_TEN from khach_hang where KH_MA = {$row["KH_MA"] }";
