/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     29/08/2023 6:12:52 PM                        */
/*==============================================================*/
...
(
   ...
   PBH_NGAYBANHANG      datetime not null,
   PBH_NGAYHETHAN       datetime not null,
...
alter table PHIEU_NHAP add constraint FK_DONHANVIENLAP foreign key (NV_MA)
      references NHAN_VIEN (NV_MA) on delete restrict on update restrict;

alter table PHIEU_NHAP add constraint FK_NCC_PN foreign key (NPP_MASO)
      references NHA_PHAN_PHOI (NPP_MASO) on delete restrict on update restrict;

alter table SAN_PHAM add constraint FK_COBAOHANH foreign key (PBH_SOPHIEU)
      references PHIEU_BAO_HANH (PBH_SOPHIEU) on delete restrict on update restrict;
